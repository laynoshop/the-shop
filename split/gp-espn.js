...
(function () {
  ...
  // gp-admin.js's static fpiHomePct/fpiAwayPct (captured once when the
  // game was added, before this live sync existed) is still read as a
  // fallback there for the rare game this hasn't synced yet.
